...
export default function GamePage() {
  ...
  useEffect(() => {
    ...
    const handlers = {
      ...
      'bid:talonOffered':  (d) => dispatch({ type: 'BID_TALON_OFFERED', ...d }),
      'bid:talonCards':    (d) => dispatch({ type: 'BID_TALON_CARDS', ...d }),
      'bid:talonTaken':    (d) => dispatch({ type: 'BID_TALON_TAKEN', ...d }),
      'bid:talonPassed':   () => {},
      'bid:discarded':     (d) => dispatch({ type: 'BID_DISCARDED', ...d }),
      'bid:placed':        (d) => dispatch({ type: 'BID_PLACED', ...d }),
      'bid:passed':        (d) => dispatch({ type: 'BID_PASSED', ...d }),
